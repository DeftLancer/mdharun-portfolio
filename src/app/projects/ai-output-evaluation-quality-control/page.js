            ...
            <div className="mx-auto max-w-[1120px] px-5 pb-24 pt-10 sm:px-6 lg:px-8 lg:pt-14">
                ...
                >
                    ...
                    <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                        A tested portfolio prototype for reviewing AI-generated
                        outputs against explicit instructions, supplied
                        evidence, quality criteria, severity rules, and
                ...
                <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)]">
                    ...
                    <div className="min-w-0">
                        <Section id="problem" title="The problem">
                            <p>
                                AI-generated content can look polished while
                                still containing factual errors, unsupported
                                claims, missing requirements, instruction
                                violations, or formatting defects. A reviewer
                                who relies mainly on fluency can therefore
                                approve an output that is confident, readable,
                                and wrong.
                            </p>
                        </Section>
                        ...
                        <Section id="goal" title="The goal">
                            <p>
                                I wanted to design a reusable evaluation
                                workflow that turns vague quality judgments into
                                evidence-backed review. The system needed to
                                distinguish between incorrect, unsupported,
                                incomplete, non-compliant, poorly formatted, and
                                merely improvable outputs.
                            </p>
                        </Section>
                        ...
                        >
                            <p>
                                The framework uses eight 0–4 evaluation
                                dimensions, then applies a severity hierarchy
                                before issuing the final PASS, REVISE, or FAIL
                                decision. This keeps a polished response from
                                passing when it contains a Critical factual or
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-950 p-6 text-slate-100 sm:p-7">
                                ...
                                <p className="mt-4 font-mono text-sm leading-8 text-slate-200">
                                    Critical Error → Essential-Dimension Failure
                                    → Major-Error Pattern → Numerical Score →
                        ...
                        <Section id="workflow" title="Workflow">
                            <p>
                                The system separates evidence collection,
                                quality review, error classification, severity
                                analysis, decision logic, revision, and final
                                human review rather than treating evaluation as
                                one impressionistic step.
                            </p>
                            <Project02Flow />
                        </Section>
                        ...
                        <Section
                            id="testing"
                            eyebrow="Testing"
                            title="Five deliberately different failure modes"
                        >
                            <p>
                                I tested the framework against constructed cases
                                designed to expose different evaluator
                                weaknesses rather than repeating the same type
                                of obvious error.
                            </p>

                            <div className="mt-8 grid items-stretch gap-4 sm:grid-cols-2 xl:grid-cols-3">
                                {tests.map(
                                    ([number, title, description, result]) => (
                                        <article
                                            key={number}
                        ...
                        <Section id="failure" title="Failure discovered">
                            <p>
                                The first evaluation design had a hidden scoring
                                problem. A single fabricated statement could
                                damage both Factual Accuracy and Groundedness,
                                which made it easy to report and penalize the
                            ...
                            <div className="mt-7 rounded-3xl border border-amber-200 bg-amber-50 p-6">
                                ...
                                <p className="mt-2 text-sm leading-7 text-amber-900/80">
                                    “Several enterprise pilots converted into
                                    signed contracts” can be both factually
                                    false and ungrounded. Treating those as two
                                    independent issues would artificially
                                    amplify one defect.
                                </p>
                            </div>
                        </Section>
                        ...
                        <Section
                            id="fixes"
                            title="The design was refined through failure-driven testing"
                        >
                        ...
                        <Section
                            id="evidence"
                            eyebrow="Evidence"
                            title="What was actually tested and changed"
                        >
                            <p>
                                The portfolio does not present the final
                                evaluator prompt as proof by itself. The
                                evidence is the sequence of constructed tests,
                                the weaknesses they exposed, and the concrete
                                rules added to address those weaknesses.
                            </p>
                            ...
                            <div className="mt-6 rounded-3xl border border-blue-100 bg-blue-50 p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-700">
                                    The framework has been tested against the
                                    defined constructed scenarios used in this
                                    project. It is not presented as a
                                    production-deployed, independently
                                    certified, or statistically benchmarked
                                    evaluation system.
                                </p>
                            </div>
                        </Section>
                        ...
                        >
                            <p>
                                The case study is intentionally readable at a
                                high level. The evaluator specification, test
                                suite, failure/fix record, and representative
                                annotated evaluation are available below for
                                deeper inspection.
                            </p>
                            <Project02Artifacts />
                        </Section>
                        ...
                        >
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-600">
                                    ...
                                    decision-support system for human reviewers,
                                    not as an independent authority. High-stakes
                                    outputs still require appropriate human
                                    verification.
                                </p>
                            </div>
                        </Section>
                        ...
                        <Section id="limitations" title="Limitations">
                            <p>
                                This is an independent tested portfolio
                                prototype. I do not claim production deployment,
                                commercial client adoption, large-scale
                                inter-rater studies, cross-model benchmarking,
                                or independently measured accuracy improvements.
                                The test suite is deliberately constructed to
                                demonstrate evaluation design and failure
                                analysis, not to establish universal
                                reliability.
                            </p>
                        </Section>
                    </div>
