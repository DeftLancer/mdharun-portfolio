            ...
            <div className="mx-auto max-w-[1120px] px-5 pb-24 pt-10 sm:px-6 lg:px-8 lg:pt-14">
                ...
                >
                    ...
                    <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                        A tested portfolio prototype for converting business
                        policy and process sources into executable internal SOPs
                        and public-safe knowledge-base content while exposing
                        ambiguity instead of inventing missing rules.
                    </p>
                    ...
                    <div className="min-w-0">
                        <Section id="problem" title="The problem">
                            <p>
                                ...
                                scattered policy notes, SME explanations,
                                process steps, and exceptions. AI can turn that
                                material into polished prose quickly, but
                                polished prose is dangerous if it silently
                                resolves source conflicts, invents missing
                                owners, overstates service levels, or exposes
                                internal-only information in public help
                                content.
                            </p>
                        </Section>
                        ...
                        <Section id="goal" title="The goal">
                            <p>
                                I designed a reusable workflow that converts
                                supplied business sources into a normalized
                                process model, an executable internal SOP,
                                and—when needed—a customer-facing knowledge-base
                                article, with source fidelity, ambiguity
                                handling, audience separation, QA, and human
                        ...
                        >
                            <p>
                                The central design decision is to surface
                                uncertainty rather than hide it. Conflicting
                                authoritative sources produce a SOURCE CONFLICT.
                                Missing operational details become OPEN
                                QUESTIONS. Public documentation is derived only
                                after internal-only information has been
                                separated.
                            </p>
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-950 p-6 text-slate-100 sm:p-7">
                                ...
                                <p className="mt-4 font-mono text-sm leading-8 text-slate-200">
                                    Sources → Conflict Check → Process Model →
                                    Information Boundary → SOP / KB →
                                    Cross-Document QA → Human Approval
                                </p>
                            </div>
                        </Section>
                        ...
                        <Section
                            ...
                            title="The workflow converts prose into an executable process model"
                        >
                            <p>
                                Before writing an SOP, the workflow extracts
                                operational structure: trigger, inputs, owner,
                                action, decision points, exceptions, escalation,
                                completion, and the evidence produced. This
                                makes missing links easier to detect than in
                                free-form prose.
                            </p>
                        ...
                        <Section
                            id="testing"
                            eyebrow="Testing"
                            title="Six tests targeted business-documentation failure modes"
                        >
                        ...
                        <Section
                            id="failures"
                            title="Testing changed the workflow"
                        >
                        ...
                        <Section
                            id="evidence"
                            eyebrow="Evidence"
                            title="What this prototype actually demonstrates"
                        >
                            ...
                            <div className="mt-6 rounded-3xl border border-blue-100 bg-blue-50 p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-700">
                                    The workflow was exercised against the
                                    constructed scenarios documented here. It is
                                    not presented as legal, compliance,
                                    security, or policy-owner approval and is
                                    not claimed to be a production-deployed
                        ...
                        >
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-600">
                                    The workflow supports documentation work.
                                    Policy, legal, compliance, security,
                                    process-owner, and publication decisions
                        ...
                        <Section id="limitations" title="Limitations">
                            <p>
                                ...
                                prototype. I do not claim client deployment,
                                measured operational savings, policy
                                certification, legal review, security approval,
                                or production knowledge-base integration. The
                                demonstration process and test cases are
                                constructed to show workflow architecture,
                                source-grounding discipline,
                                information-boundary design, and failure-driven
                                refinement.
                            </p>
                        </Section>
                    </div>
