            ...
            <div className="mx-auto max-w-[1120px] px-5 pb-24 pt-10 sm:px-6 lg:px-8 lg:pt-14">
                ...
                >
                    ...
                    <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                        A tested portfolio prototype for connecting educational
                        objectives to instruction, examples, practice,
                        assessment, verification, and human review.
                    </p>
                ...
                <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)]">
                    ...
                    <div className="min-w-0">
                        <Section id="problem" title="The problem">
                            <p>
                                AI can produce educational content quickly, but
                                fast generation does not guarantee instructional
                                alignment, learner-level fit, conceptual
                                accuracy, valid examples, assessment coverage,
                                or a correct answer key. A polished lesson can
                                still fail as a learning experience.
                            </p>
                        </Section>

                        <Section id="goal" title="The goal">
                            <p>
                                I designed a reusable workflow that starts with
                                an educational brief and creates a traceable
                                lesson package in which learning objectives
                                connect to explanation, examples, guided
                                practice, independent practice, assessment,
                                verification, and final human review.
                            </p>
                        </Section>
                        ...
                        >
                            <p>
                                The central rule is simple: if a section cannot
                                be linked to a learning objective, prerequisite,
                                relevant misconception, or assessment need, it
                                should normally be removed or shortened. This
                                limits attractive but unnecessary AI-generated
                                content.
                            </p>
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-950 p-6 text-slate-100 sm:p-7">
                                ...
                                <p className="mt-4 font-mono text-sm leading-8 text-slate-200">
                                    Objective → Instruction → Worked Example →
                                    Guided Practice → Independent Practice →
                                    Assessment → Answer Verification
                                </p>
                            </div>
                        </Section>
                        ...
                        <Section id="workflow" title="Workflow">
                            <p>
                                The workflow separates feasibility, objective
                                mapping, generation, verification, QA, and human
                                review so that a lesson is not treated as
                                complete simply because a language model has
                                produced it.
                            </p>
                            <Project03Flow />
                        </Section>
                        ...
                        <Section
                            ...
                            title="Learning objectives remain visible through the whole lesson"
                        >
                            <p>
                                Each objective receives a stable tag. The tag is
                                reused across examples, practice, and assessment
                                so a reviewer can see whether an objective was
                                taught and whether it was actually measured.
                            </p>
                        ...
                        <Section
                            id="testing"
                            eyebrow="Testing"
                            title="Five tests targeted different instructional failure modes"
                        >
                        ...
                        <Section
                            id="failures"
                            title="Testing changed the design"
                        >
                        ...
                        >
                            ...
                            <div className="mt-6 rounded-3xl border border-blue-100 bg-blue-50 p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-700">
                                    ...
                                    constructed scenarios documented in this
                                    case study. It is not presented as a
                                    production-deployed curriculum platform or
                                    as independently validated pedagogy.
                                </p>
                            </div>
                        </Section>
                        ...
                        >
                            ...
                            <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6">
                                ...
                                <p className="mt-3 text-sm leading-7 text-slate-600">
                                    ...
                                    Curriculum alignment, classroom suitability,
                                    and publication approval remain human
                                    responsibilities when those decisions
                                    matter.
                                </p>
                            </div>
                        </Section>
                        ...
                        <Section id="limitations" title="Limitations">
                            <p>
                                ...
                                prototype. I do not claim school deployment,
                                student-outcome improvement, formal curriculum
                                certification, teacher validation studies, or
                                production LMS integration. The demonstration
                                lesson and test cases are designed to show
                                workflow architecture, instructional
